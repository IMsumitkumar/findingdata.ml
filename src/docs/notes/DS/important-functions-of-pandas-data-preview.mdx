...
image01alt: Some important data preview functions in pandas
...
Before reading this, I suggest you read the previous post [Intro and data I/O with pandas](/notes/DS/handle-different-file-formats-with-pandas/)

![img](https://i.imgur.com/YO1140L.jpg)
