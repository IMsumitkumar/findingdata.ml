---
title: pandas 🐼
description: All you need from pandas 
---
...
Binary file format or json format etc. so dealing with these file format becomes little bit though.

In this post, we will see how can we read and write diffrent type of file format using pandas.
